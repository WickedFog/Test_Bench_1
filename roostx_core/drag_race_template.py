...
#
# GROK FIXES APPLIED:
#   Bug 3:  SC2 -> SC_down  (SC2 does not exist; SC_down = momentary held, SC1 invalid)
...
#   L1 -- Throttle > 0.5% AND transbrake held (SC pressed down)
...
# Arrow characters for momentary switch notation
SC_DOWN = "\u2193"  # SC pressed/held
SC_UP   = "\u2191"  # SC released
...
def build():
    ...
    #   SC_DOWN = pressed/held, SC_UP = released
    ...
    # L4 -- Master arm
    #   Set=SA2 (Burnout mode), Clear=SA0 (Race mode)
    m.add_logical_switch(
        index=3,
        func="FUNC_STICKY",
        v1="SA2", v2="SA0",
    ...
    # -- CUSTOM FUNCTIONS -----------------------------------------------------
    # CF0 -- Master throttle block: kill CH2 when disarmed
